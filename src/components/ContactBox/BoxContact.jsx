...
function BoxContact() {
  return (
    ...
    <div className="flex flex-row  items-center justify-around max-sm:flex-col max-lg:flex-col  max-xl:flex-col w-9/12 h-[150px]
...
delay-50 hover:shadow-GRC transition-all delay-50 mb-3">
    <div className='flex flex-row justify-around items-center w-[500px] h-[90px] '>
        <img className='flex flex-row h-[68px] w-[68px] ' src={Instagram} alt="" />
        <img className='flex flex-row h-[55px] w-[55px]' src={Telegram} alt="" />
        <img className='flex flex-row h-[70px] w-[70px]' src={Linkdin} alt="" />
    </div>
    <div className='flex flex-col justify-center items-center w-[500px] h-[90px] '>
        ...
        <p className='flex text-white font-bold'>Gmail : moradiweb.ir@gmail.com</p>
    </div>
    </div>
    </div>
  )
