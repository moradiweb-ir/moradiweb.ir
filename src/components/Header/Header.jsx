export default function Header(){
    return(
        <div className="flex justify-center  " >
                 <div className=" flex flex-row justify-center w-9/12 h-20 bg-boxblue rounded-b-lg  shadow shadow-transparent delay-50 hover:shadow-GR transition-all delay-50 ">
